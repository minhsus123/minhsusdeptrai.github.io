...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "skibidi skibidi dop dop yes yes xin chào cả nhà nha",
    "\"Hello, World!\""
  ];
  let bioText = '';
  let bioIndex = 0;
    ...
    if (!isShowingSkills) {
      gsap.to(profileBlock, {
        ...
        onComplete: () => {
          ...
          gsap.to(pythonBar, { width: '0', duration: 2, ease: 'power2.out' });
          gsap.to(cppBar, { width: '0', duration: 2, ease: 'power2.out' });
          gsap.to(csharpBar, { width: '0', duration: 2, ease: 'power2.out' });
        }
      });
